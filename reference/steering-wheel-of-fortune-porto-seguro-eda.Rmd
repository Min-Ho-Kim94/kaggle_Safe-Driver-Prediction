...
train <- as.tibble(fread('~/safe driver data file/train.csv', na.strings=c("-1","-1.0")))
test <- as.tibble(fread('~/safe driver data file/test.csv', na.strings=c("-1","-1.0")))
sample_submit <- as.tibble(fread('~/safe driver data file/sample_submission.csv'))
```
